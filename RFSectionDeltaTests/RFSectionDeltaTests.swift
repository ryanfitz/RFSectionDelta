...
class RFSectionDeltaTests: XCTestCase {
    ...
    func testAddItemsWithNilArray() {
        ...
        assertIndexSetEquals(indexSet: delta.addedIndices!, expected : [0, 1, 2, 3])
    }
    ...
    func testRemoveAllItems() {
        ...
        assertIndexSetEquals(indexSet: delta.removedIndices!, expected : [0, 1, 2, 3])
    }
    ...
    func testAddItemsToExistingArray() {
        ...
        assertIndexSetEquals(indexSet: delta.addedIndices!, expected : [4, 5])
        assertIndexSetEquals(indexSet: delta.unchangedIndices!, expected : [0, 1, 2, 3])
    }
    ...
    func testAddAndRemoveItems() {
        ...
        assertIndexSetEquals(indexSet: delta.removedIndices!, expected : [2])
        assertIndexSetEquals(indexSet: delta.addedIndices!, expected : [2, 3, 4])
        assertIndexSetEquals(indexSet: delta.unchangedIndices!, expected : [0, 1])
    }
    ...
    func testAllUnchangedItems() {
        ...
        assertIndexSetEquals(indexSet: delta.unchangedIndices!, expected : [0, 1, 2])
    }
...
//        XCTAssert(delta.movedIndexes == nil, "moved indices nil")
        ...
        XCTAssertNotNil(delta.addedIndices, "added indices")
        assertIndexSetEquals(indexSet: delta.removedIndices!, expected : [3])
        assertIndexSetEquals(indexSet: delta.addedIndices!, expected : [0])
    }
}
